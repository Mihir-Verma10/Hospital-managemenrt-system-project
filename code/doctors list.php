...
<body>
<h1 style="position:absolute;top:20;left:400px;font-family:algerian;color:red;width:380px"><u>here is the list of all doctors </u></h1></body></html>
	...
	while($row=mysqli_fetch_array($query1))
{
    ...
    echo $row["specialization"]." </td><br/><td>";
    echo "</tr>";
